...
#from load to loadH 
load=pd.read_csv('C:/Users/giaco/OneDrive - Politecnico di Milano/Crevani - CESP/Project with Gommyr/RAMP-master/ramp/results/output_file_3.csv',usecols=['0'])
load.index = minute_index
loadH = load.resample('H').mean() 
loadH.index = hour_index

#export in .csv 
loadH.to_csv('hh_only.csv')
